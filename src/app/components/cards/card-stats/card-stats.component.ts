...
export class CardStatsComponent implements OnInit {
  ...
  @Input()
  get statSubtitle(): string { return this._statSubtitle; }
  ...
  @Input()
  get statTitle(): string { return this._statTitle; }
  ...
  @Input()
  get statArrow(): string { return this._statArrow; }
  ...
  @Input()
  get statPercent(): string { return this._statPercent; }
  ...
  // from tailwindcss
  @Input()
  get statPercentColor(): string { return this._statPercentColor; }
  ...
  @Input()
  get statDescripiron(): string { return this._statDescripiron; }
  ...
  @Input()
  get statIconName(): string { return this._statIconName; }
  ...
  // from tailwindcss
  @Input()
  get statIconColor(): string { return this._statIconColor; }
